...
export function OrderDetailsTable( { order } : { order: Order}) {
    const { id, 
        shippingAddress, 
        orderitems, itemsPrice, shippingPrice, taxPrice, 
        totalPrice, paymentMethod, isPaid, isDelivered, paidAt, deliveredAt  } = order;
            ...
            <div className="col-span-2 space-4-y overflow-x-auto">
                ...
                <Card className="my-2">
                    <CardContent className="p-4 gap-4">
                        ...
                        { isDelivered ? (
                            <Badge variant={'secondary'}>
                                Deliverd at { formatDateTime(deliveredAt!).dateTime}
                            </Badge>
                        ) : (
                            <Badge variant={'destructive'}>
                                Not Deliverd
